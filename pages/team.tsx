    ...
    return (
        <div className="container" >
            ...
            <Row>
                ...
                <IndivTeamMemberCard imgSrc={"../assets/team-photos/mega.jpg"} name={"Mega Olonbayar"} role={"Marketing/Content Content Lead"} linkedin={"https://www.linkedin.com/in/myagmarsuren-olonbayar-08773a22a/"}/>
